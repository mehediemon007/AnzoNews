        ...
        <>
            <div className="single-blog bg-white">
                <div className="blog-list-view">
                    <div className="blog-image rounded-0"><a href="-details"><img src={`images/fashion/${image}`} alt={alt}/></a></div>
                    <div className="blog-content bg-white">
                        <a href="blog-details.html"><h4 className="blog-title overflow-title">{title}</h4></a>
